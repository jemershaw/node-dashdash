            ...
            optNames.forEach(function (optName) {
                if (optName.length === 1) {
                    if (includeHidden || !o.hidden) {
                        ...
                        shortoptsdescription.push(optDescription);
                    }
                    ...
                    if (includeHidden || !o.hidden) {
                        ...
                        longoptsdescription.push(optDescription);
                    }
                    optargs.push('--' + optName + '=' + completionType);
                }
